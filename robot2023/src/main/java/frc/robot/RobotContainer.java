...
private final tiltup m_Tiltup = new tiltup(m_arm);
private final tiltdown m_Tiltdown = new tiltdown(m_arm);  
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("noVacuum", new noVacuum());
...
public Joystick getButtonboard() {
    ...
    // buttons
    private JoystickButton tiltup = new JoystickButton(joystick1, 0);
  /**
