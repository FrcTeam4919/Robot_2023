...
import frc.robot.commands.close;
import frc.robot.commands.in;
import frc.robot.commands.noVacuum;
import frc.robot.commands.open;
import frc.robot.commands.out;
...
>>>>>>> 5a6a8e6283d455ef7658d0ff46f22fa5449b4ae1
...
private final close m_Close = new close(m_claw);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("tilt up front", new tiltupfront( m_arm ));
    SmartDashboard.putData("tilt down front", new tiltdownfront( m_arm ));
    SmartDashboard.putData("tilt up back", new tiltupback( m_arm ));
    SmartDashboard.putData("tilt down back", new tiltdownback( m_arm ));
    ...
    m_driveTrain.setDefaultCommand(
      new defualtDrive(
        m_driveTrain, joystick1::getY, joystick1::getX));
