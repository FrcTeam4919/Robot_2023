...
rightShift = new Solenoid(0, PneumaticsModuleType.REVPH, 11);
 addChild("rightShift", rightShift);
 

leftShift = new Solenoid(0, PneumaticsModuleType.REVPH, 13);
 addChild("leftShift", leftShift);
 
/** Shifter double solenoid replacement code
 * rightShift = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 11, 12);
 * 
 * leftShift = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 13, 14);
 */
