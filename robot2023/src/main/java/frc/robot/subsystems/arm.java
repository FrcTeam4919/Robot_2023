...
front1 = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 0, 1);
 addChild("front 1", front1);
 

back1 = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 4, 5);
 addChild("back 1", back1);
 

front2 = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 2, 3);
 addChild("front 2", front2);
 

back2 = new DoubleSolenoid(0, PneumaticsModuleType.REVPH, 6, 7);
